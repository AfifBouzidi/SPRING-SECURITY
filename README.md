...
Spring security s’appuie sur une chaine de filtres dont la classe DelegatingFilterProxy  représente le point d’entrée, elle intercepte les requêtes http et déclenche les services d’authentification et d’autorisation
