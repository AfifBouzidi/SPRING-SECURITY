...
![](https://github.com/AfifBouzidi/SPRING-SECURITY/blob/master/filterChain.png)  
...
Généralement et pour des raisons de sécurité le mot de passe n'est pas stocké en clair. Pour chaque utilisateur le hash du mot de passe est sauvegardé. L’authentification se fait en comparant les mots de passe hachés. 
- *PasswordEncoder*  
...
![](https://github.com/AfifBouzidi/SPRING-SECURITY/blob/master/AccessDecisionManager_.png)  
...
La méthode vote de l'interface AccessDecisionVoter retourne trois valeurs possibles  

-	ACCESS_GRANTED :  réponse positive   

-	ACCESS_DENIED: réponse negative   

-	ACCESS_ABSTAIN: voter pour s'abstenir  
